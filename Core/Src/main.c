...
extern volatile unsigned char uart1_rx_flag;

extern unsigned char test_buffer_rx[50];
extern int test_buffer_flag;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, USER_LED_GREEN_Pin|USER_LED_RED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : USER_LED_GREEN_Pin USER_LED_RED_Pin */
  GPIO_InitStruct.Pin = USER_LED_GREEN_Pin|USER_LED_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void IOE_Init(void) 
{
  ...
  //This is done with cubmx and is therfore not done here.
	//HAL_GPIO_TogglePin(USER_LED_GREEN_GPIO_Port, USER_LED_GREEN_Pin);
	//printf("fuckyou\n");
	//stmpe811_ts_drv.EnableIT(0x82);
	//stmpe811_EnableGlobalIT(0x82);
	//stmpe811_EnableITSource(0x82, STMPE811_GIT_TOUCH);
}
